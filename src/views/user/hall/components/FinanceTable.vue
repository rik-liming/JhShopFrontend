...
const handleRowClick = (row) => {
  ...
  switch(row.transaction_type) {
    case 'recharge':
      targetPage = `/recharge/detail?reference_id=${row.reference_id}&goback=/hall&myTableType=finance`
      break;
    case 'transfer':
      targetPage = `/transfer/detail?reference_id=${row.reference_id}&goback=/hall&myTableType=finance`
      break;
    case 'withdraw':
      targetPage = `/withdraw/detail?reference_id=${row.reference_id}&goback=/hall&myTableType=finance`
      break;
    case 'transfer_send':
      targetPage = `/transfer/sender/detail?reference_id=${row.reference_id}&goback=/hall&myTableType=finance`;
      break;
    case 'transfer_receive':
      targetPage = `/transfer/receiver/detail?reference_id=${row.reference_id}&goback=/hall&myTableType=finance`;
      break;
    case 'order_sell':
    case 'order_auto_sell':
      targetPage = `/order/seller/detail?orderId=${row.reference_id}&goback=/hall&myTableType=finance`;
      break;
    case 'order_buy':
    case 'order_auto_buy':
      targetPage = `/order/buyer/detail?orderId=${row.reference_id}&goback=/hall&myTableType=finance`;
      break;
  }
