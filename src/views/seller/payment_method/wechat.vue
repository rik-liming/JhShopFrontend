    ...
    <div class="tw-w-[90%] tw-p-1 tw-text-center tw-flex tw-flex-col tw-justify-start tw-items-center">
      ...
      <div class="tw-w-full tw-flex tw-items-center tw-justify-between tw-mt-14 tw-mb-2 tw-relative">
        <div class="tw-flex tw-items-center tw-w-full">
          <img src="@/assets/wechat_pay.png" alt="logo" class="tw-w-[126px] tw-h-[126px] tw-mx-auto" />
        </div>
        ...
        <div class="tw-absolute tw-top-[-24px] tw-right-[-12px] tw-flex tw-flex-col tw-items-end tw-mt-36">
          <p class="tw-text-sm tw-mb-2 tw-mr-4 tw-font-songti tw-font-bold tw-text-[#333333]">市场汇率：<span class="tw-text-red-500 tw-font-pingfang tw-font-normal" style="color: rgba(rgba(217, 0, 27, 0.854901960784314))">{{ configStore.config?.value?.exchange_rate_wechat }}</span></p>
        </div>
      </div>
      ...
      <div class="tw-w-[70%] tw-text-[#333333]">
        ...
        <form @submit.prevent="paymentHandle" class="tw-mb-4">
          <div class="tw-text-left tw-mb-3 tw-mt-12">
            <p class="tw-text-md tw-font-pingfang tw-font-normal">微信号：</p>
          </div>
          <input
            type="text"
            placeholder="邮箱 / 手机"
          ...
          <div class="tw-text-left tw-mt-8 tw-mb-3">
            <div class="tw-flex tw-justify-start tw-items-center tw-mb-6">
              <p class="tw-text-md tw-font-pingfang tw-font-normal">微信收款码：</p>
      ...
      <!-- 底部版权 -->
      <p class="tw-text-xs tw-text-gray-400 tw-mt-0">Copy@ JH嘉禾商城</p>
    </div>
  </div>
</template>
